...
/**
 * SCOPES allows you to set access levels; this is set to readonly for now because you don't have access rights to update the calendar yourself. For more info, check out the SCOPES documentation at this link: https://developers.google.com/identity/protocols/oauth2/scopes
 */
...
const credentials = {
  ...
  redirect_uris: ['https://leevee6039.github.io/meet/'],
  javascript_origins: ['https://leevee6039.github.io', 'http://localhost:3000']
};
